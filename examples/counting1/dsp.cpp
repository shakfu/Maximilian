...
double freq; // This is a variable that we will use to hold and set the current
...
void play(double* output)
{
    ...
    myClock.ticker(); // This makes the clock object count at the current
                      // samplerate

    // This is a 'conditional'. It does a test and then does something if the
    // test is true

    if (myClock.tick) { // If there is an actual tick at this time, this will
                        // be true.
