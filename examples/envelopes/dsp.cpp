// Envelopes allow you to shape the sound. The basic idea is that a sound has
// the following shape
...
void play(double* output)
{
    ...
    // notice that we feed in a value of 1. to create an envelope shape we can
    // apply later.
    ...
    if (CurrentCount < 5)
        ...
        myOscOutput = mySwitchableOsc.sinewave(
            CurrentCount
            * 50); // one osc object can produce whichever waveform you want.
